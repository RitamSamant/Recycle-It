    ...
    <div className="welcome">
      ...
      <div className="py-[1rem] border-b">
         <div className="flex mx-auto justify-center">
            ...
            <h1 className="font-odesans-semibold text-5xl text-center text-indigo-600">Recyclit</h1>
         </div>
      </div>
      <div className="flex w-5/6 mx-auto justify-center gap-5 mt-5">
        <div className="w-full border-2 rounded-t-[20rem] border-sky-100">
        ...
        <Image src={welcome} alt="" className="h-[40rem] w-[30rem] border-2 rounded-t-[20rem] border-sky-100" />
        <div className="w-full border-2 rounded-t-[20rem] border-sky-100">
         <div className="my-auto h-full flex flex-col justify-center items-center gap-10">
