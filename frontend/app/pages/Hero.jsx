  ...
  return (
    <section id="hero" className="h-screen relative">
      ...
      <div className="z-10 flex flex-col h-screen items-center justify-center">
        ...
        <p className="text-neutral-900 mt-10 phone:w-[90%] lg:w-[40%] text-center font-medium phone:text-sm lg:text-base">Championing A Greener Future by Embracing Recycling and Harnessing the Potential of Recycled Products to Safeguard Our Planet Health and Promote Sustainable Prosperity.</p>
