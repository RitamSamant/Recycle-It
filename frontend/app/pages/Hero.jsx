  ...
  return (
    <section id="hero">
      ...
      <div className="flex justify-between w-5/6 mx-auto mt-36 mb-20">
        <Image src={flower} alt="" className="phone:w-10 phone:h-10 lg:w-20 lg:h-20 phone:mb-auto lg:mb-0" />
        ...
        <Image src={lotus} alt="" className="phone:w-10 phone:h-10 lg:w-20 lg:h-20 mb-auto" />
        <button></button>
      </div>
      <div className="relative phone:-mt-16 lg:-mt-0">
