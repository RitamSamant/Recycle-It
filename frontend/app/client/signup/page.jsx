    ...
    <div className="flex items-center justify-center h-screen bg-[#C4D7B2]">
      <div className="signup lg:p-8 p-5 shadow-md rounded-lg lg:w-1/4 w-[87%]">
        ...
        <form>
          ...
          <div className="mb-4">
            <label htmlFor="bankAccount" className="block font-odesans-medium mb-1">
              Bank Account:
            </label>
            <input
              type="text"
        ...
        <p className='font-odesans-medium text-center mt-5'>Already Signed in? <Link href="/client/login" className='underline text-emerald-950 font-medium'>Login</Link></p>
      </div>
    </div>
  );
};
