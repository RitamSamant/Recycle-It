  ...
  return (
    <div className="bg-[#DBC4F0] flex items-center justify-center h-screen">
      <div className="card lg:p-8 p-5 shadow-md rounded-lg lg:w-1/4 w-[87%]">
        ...
        <form>
          <div className="mb-4">
            <label htmlFor="email" className="block font-odesans-medium mb-1">
              Email:
            </label>
            <input
              type="email"
              id="email"
              name="email"
              className="w-full px-3 py-2 border rounded-md bg-white/40 text-black outline-none font-odesans-medium"
              required
          ...
          <button
            type="submit"
            className={`w-full py-2 rounded-md font-odesans-medium text-lg mt-4 ${
              isLoggingIn
          ...
          <p className='font-odesans-medium text-center mt-5'>Not logged in? <Link href="/client/signup" className='underline text-purple-950'>Signup</Link></p>
        </form>
      </div>
    </div>
  );
