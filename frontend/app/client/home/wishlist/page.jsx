...
const Page = () => {
  ...
  useEffect(() => {
    const getProducts = async () => {
      try {
        ...
        "https://recycle-it.onrender.com/client/dashboard/wishlistedProduct",
        {
          headers: {
      ...
      setData(res.data.wishlistforClient);
      if (res.data.wishlistforClient) {
        const occurrences = {};
        res.data.wishlistforClient.forEach(item => {
        ...
        const uniqueProducts = res.data.wishlistforClient.filter((item, index, self) =>
  ...
  return (
   <div className="panel min-h-screen py-5">
        ...
        Data.map((items, index) => (
          <div className="bg-white/10 border-2 flex flex-col justify-between lg:gap-7 border-white/10 lg:h-72 rounded-2xl lg:grid lg:grid-cols-2 lg:my-0 phone:my-5 px-3 shadow-lg" key={index}>
            ...
            <div className="my-5 flex flex-col justify-between phone:gap-7 lg:gap-0">
              ...
              <div className="flex lg:flex-col phone:gap-5 lg:gap-2">
