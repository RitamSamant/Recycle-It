        ...
        <div className="phone:mt-5 lg:mt-10 lg:grid grid-cols-[2fr_1.5fr_1fr]">
          ...
          <div className="mx-auto justify-center items-center flex text-white border-l-2 border-white/10 px-5 phone:pb-10">
            <form >
              ...
              <h1 className="text-lg mb-4 font-roxale text-white/90 phone:text-center">How would you like your pickup schedule be?</h1>
              ...
              <Toaster position="bottom-right" reverseOrder={false} />
                <button
                  type="button"
                  className="bg-black rounded-md border-2 border-white/10 shadow-xl text-white px-10 font-roxale py-2 mt-10 flex mx-auto"
