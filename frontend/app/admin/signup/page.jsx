     ...
     <div className="flex items-center justify-center h-screen py-36 lg:py-5 bg-neutral-800">
      <div className="bg-white/20 lg:p-8 p-5 shadow-md rounded-lg lg:w-1/4 w-[87%]">
        ...
        <form>
          ...
          <div className="mb-4">
            <label htmlFor="buisnessBankAccount" className="block font-roxale mb-1">
              Bank Account
            </label>
            <input
              type="text"
        ...
        <p className='font-roxale text-center mt-5'>Already Signed in? <Link href="/admin/login" className='underline text-emerald-950'>Login</Link></p>
      </div>
    </div>
  );
};
