            ...
            <div className="bg-white/10 border-2 border-white/10 p-6 rounded-lg">
              ...
              {cartItems.length > 0 ? (
                <div>
                  <button
                    onClick={clearCart}
                    className="flex border-2 border-white/10 mt-2 w-full justify-between px-3 py-2 rounded-lg bg-white/10"
                  >
                    <h1 className="text-lg my-auto">Clear</h1>
                    <Image src={trash} alt="" className="w-5 h-5 my-auto" />
                  </button>
                </div>
              ) : (
